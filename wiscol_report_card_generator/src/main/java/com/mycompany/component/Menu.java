...
public class Menu extends javax.swing.JPanel {
    ...
    private void init(){
        ...
        listMenu1.addItem(new Model_Menu("school", "Subjects", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("power-off", "Logout", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("", "",Model_Menu.MenuType.EMPTY));
    }
    ...
    private void initComponents() {
        ...
        panelMoving.setPreferredSize(new java.awt.Dimension(215, 86));

        jLabel1.setFont(new java.awt.Font("SansSerif", 1, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setIcon(new javax.swing.ImageIcon("D:\\projects\\java\\wiscol\\WISCOL_report\\wiscol_report_card_generator\\src\\main\\java\\com\\mycompany\\icon\\logo.png")); // NOI18N
